...
/* ---------------- 代码跳转（FR-20 / M9 增强） ----------------
 * 跳转流程已重构拆出至 navigation.ts / navigationStore.ts / PeekView.tsx
 * （转到定义 Peek、查找引用 Peek、后退/前进历史栈），此处仅保留命令注册。
 */
...
export function registerCoreCommands(): void {
  registerCommands([
    ...
    },
    {
      ...
      category: "转到",
      keybinding: "f12",
      run: () => void gotoDefinitionCommand(),
    },
    {
      ...
      category: "转到",
      keybinding: "alt+f12",
      run: () => void gotoDefinitionCommand(true),
    },
    {
      ...
      run: () => void findReferencesCommand(),
    },
    {
